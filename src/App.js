...
//     </Float>
//     <Float>
//       <Splat alphaTest={0.1} src={`${cakewalk}/nike.splat`} scale={0.5} position={[0, 1.6, -1.5]} rotation={[Math.PI, 0, Math.PI]} />
//     </Float>
//     <Float>
...
//     <Splat alphaHash src={`${cakewalk}/nike.splat`} scale={0.5} position={[0, 1.6, -1.5]} rotation={[Math.PI, 0, Math.PI]} />
...
//     <Splat alphaTest={0.1} src={`${cakewalk}/nike.splat`} scale={0.5} position={[-0.05, 1.1, 0.05]} rotation={[-0.51, 0, 0.1]} />
//   </RigidBody>
// )
